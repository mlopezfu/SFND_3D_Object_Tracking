...
// Changed here to be used in the iteration.
    ...
    string ttcTable="",ttcTableHeader="| Det/Desc | 01-02   | 02-03   | 03-04   | 04-05   | 05-06   | 06-07   | 07-08   | 08-09   | 09-10| 10-11| 11-12| 12-13| 13-14| 14-15| 15-16| 16-17| 17-18| 18-19| Deviation| \r\n";
    ttcTableHeader+="| :-------: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | \n";
    string ttcLidarRow="";
...
{// To iterate throug detector types
    ...
    bool bVisTTC=false,bVisDetector=false,bVis3D = false,bVisYolo=false,bVisDescriptor=false;//bVis = false,
            ...
            */
            ...
            for (auto it1 = (dataBuffer.end() - 1)->bbMatches.begin(); it1 != (dataBuffer.end() - 1)->bbMatches.end(); ++it1)
            {
                ...
                if( currBB->lidarPoints.size()>0 && prevBB->lidarPoints.size()>0 ) // only compute TTC if we have Lidar points
                {
                    ...
                    ttcLidarRow+=ttcLidarRounded.str()+" |";
                    ttcTable+=ttcCameraRounded.str()+" |";
                    #endif
                    //bVis = true;
